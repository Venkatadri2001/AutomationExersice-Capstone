...
public class StepDefinition {
  ...
  //Click 'Register / Login' button after clicking checkout
	...
	public void user_uploads_file() {
        ...
        File file = new File("F:/download/automationExercise/automationExercise/Automation text file.txt"); 
	...
	public void verify_success_message_is_visible() {
	 ...
	 @Then("Verify home page is visible")
		public void verify_home_page_is_visible() {
		    WebElement someHomeElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h2[text()='Home']")));
		    Assert.assertTrue(someHomeElement.isDisplayed(), "Home page heading not visible.");
		}
	 ...
	 @When("User clicks on Test Cases button")
	  ...
	  //testcase 08//
	    ...
	    public void user_clicks_on_view_product_of_the_first_product() {
	    	 WebElement firstProduct = driver.findElement(By.xpath("(//div[@class='col-sm-9 padding-right']//div[2]//div[1]//div[1]//div[2]//div[1]//a[1]"));
		     firstProduct.click();
	 ...
	 //testcase 11//
	    ...
	    public void user_enters_email_address_in_subscription_input() {
	        driver.findElement(By.id("susbscribe_email")).sendKeys("Automation07@gmail.com");//register mail
    ...
    public void user_clicks_on_view_cart_button() {
        ...
        viewCart.click();
        System.out.println("View cart displayed");
    }
    ...
    //testcase 19//
    @Then("Verify that {string} are visible on left sidebar")
    public void verify_that_are_visible_on_left_sidebar(String section) {
        WebElement sidebarSection = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//h2[contains(text(),'" + section + "')]")));
        Assert.assertTrue(sidebarSection.isDisplayed(), section + " is not visible!");
    }
    ...
    public void user_clicks_on_brand(String brandName) {
        WebElement brandLink = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//div[@class='brands_products']//a[contains(text(),'" + brandName + "')]")));
        brandLink.click();
    }
    ...
    public void user_should_be_navigated_to_brand_page_and_products_should_be_displayed(String brandName) {
        WebElement brandTitle = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//h2[@class='title text-center']")));
        Assert.assertTrue(brandTitle.getText().toLowerCase().contains(brandName.toLowerCase()),
                "Brand page title does not match: " + brandName);

        Assert.assertFalse(driver.findElements(By.xpath("//div[@class='features_items']/div")).isEmpty(),
                "No products displayed for brand: " + brandName);
    }
    ...
    public void verify_user_is_navigated_to_page_successfully(String pageTitle) {
        WebElement title = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//h2[@class='title text-center']")));
        Assert.assertEquals(title.getText().toUpperCase(), pageTitle.toUpperCase());
    }

    @Then("Verify {string} is visible")
    public void verify_is_visible(String sectionText) {
        WebElement section = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//a[contains(text(),'" + sectionText + "')] | //h2[contains(text(),'" + sectionText + "')]")));
        Assert.assertTrue(section.isDisplayed(), sectionText + " is not visible!");
    }
    ...
    public void user_clicks_on_submit_button(String buttonText) {
    ...
    public void verify_are_visible(String sectionText) {
        WebElement section = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//a[contains(text(),'" + sectionText + "')] | //h2[contains(text(),'" + sectionText + "')]")));
        Assert.assertTrue(section.isDisplayed(), sectionText + " is not visible!");
    }
    @When("User clicks on {string} on Recommended product")
    public void user_clicks_on_on_recommended_product(String buttonText) {
        WebElement addToCartBtn = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//div[@id='recommended-item-carousel']//a[contains(text(),'" + buttonText + "')]")));
        addToCartBtn.click();

        // Wait for modal popup
        wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//button[contains(text(),'Continue Shopping')] | //u[contains(text(),'View Cart')]")));
    }

    @And("User clicks on cart {string} button")
    public void user_clicks_on_cart_button(String buttonText) {
        WebElement viewCartBtn = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//u[contains(text(),'" + buttonText + "')] | //a[contains(text(),'" + buttonText + "')]")));
        viewCartBtn.click();
    }
